...
import {
  ...
  MessageSquare, CheckCircle, TrendingUp, Mail, Globe, ClipboardList, Sparkles, Briefcase
} from 'lucide-react';
...
export default function LandingPage() {
  ...
  return (
    <main className="bg-white min-h-screen font-sans selection:bg-[#0f4c81] selection:text-white">
      ...
      <section className="relative min-h-[600px] flex flex-col justify-center px-4 md:px-12 py-24 md:py-32 overflow-hidden bg-[#00355f]">
        ...
        <div className="relative z-10 max-w-xl lg:max-w-2xl pt-10 w-full lg:w-[55%] animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-6">
            Encuentra al <span className="text-[#fc8127]">experto ideal</span> para tu próximo proyecto.
          </h2>
          <p className="text-lg text-blue-100 mb-10 max-w-xl leading-relaxed">
            La plataforma líder en servicios profesionales. Plomeros, electricistas y constructores verificados en un solo lugar.
          </p>
          ...
          <div className="bg-white/95 backdrop-blur-xl p-5 rounded-2xl shadow-2xl w-full flex flex-col gap-4 border border-white/20">
            ...
            <button
              ...
              className="w-full relative rounded-xl transition-all shadow-md active:scale-[0.98] overflow-hidden p-[2px] mt-1"
            >
              ...
              <div className="relative w-full h-full py-3.5 bg-[#fc8127] hover:bg-[#e67320] text-white font-bold rounded-[10px] flex items-center justify-center gap-2 text-base md:text-lg transition-colors">
        ...
        <div className="hidden lg:block absolute right-0 bottom-0 w-[45%] h-[95%] pointer-events-none z-0">
          <div className="absolute inset-0 bg-gradient-to-t from-[#00355f] via-[#00355f]/20 to-transparent z-10"></div>
          <div className="absolute inset-0 bg-gradient-to-r from-[#00355f] via-transparent to-transparent z-10"></div>
          <img
            src="/familia_hero.png"
      ...
      {/* Servicios Populares — Carrusel Infinito */}
      <section className="py-20 px-4 md:px-12">
        <div className="flex justify-between items-end mb-10 border-b border-gray-200 pb-4 max-w-7xl mx-auto">
          <div>
        ...
        {/* Track de carrusel con overflow hidden y fade lateral */}
        <div
        ...
        >
          {/* Pista animada — duplicada para loop infinito */}
          <div className="carousel-track flex gap-6 w-max">
            {/* ── Set 1 ── */}

            {/* Plomería */}
            <div className="w-[300px] shrink-0 bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:border-[#00355f] hover:shadow-xl transition-all group cursor-pointer" onClick={() => router.push('/buscar-profesionales?oficio=Plomería')}>
              ...
              <div className="p-5">
                <div className="flex justify-between items-start mb-2">
                  <h4 className="font-extrabold text-lg text-gray-900 group-hover:text-[#00355f] transition-colors">Plomería</h4>
                  <Droplet className="w-5 h-5 text-[#fc8127]" />
                </div>
                <p className="text-gray-500 text-sm mb-5 leading-relaxed">Reparaciones, instalaciones y urgencias las 24hs en todo momento.</p>
                <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                  <span className="text-[10px] font-extrabold text-gray-400 uppercase tracking-wider">Desde $15.000</span>
                  <button className="bg-blue-50 text-[#00355f] font-bold px-4 py-2 rounded-xl text-sm group-hover:bg-[#00355f] group-hover:text-white transition-colors">Solicitar</button>
                </div>
              </div>
            </div>

            {/* Electricidad */}
            <div className="w-[300px] shrink-0 bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:border-[#00355f] hover:shadow-xl transition-all group cursor-pointer" onClick={() => router.push('/buscar-profesionales?oficio=Electricidad')}>
              <div className="relative h-52 overflow-hidden">
              ...
              <div className="p-5">
                <div className="flex justify-between items-start mb-2">
                  <h4 className="font-extrabold text-lg text-gray-900 group-hover:text-[#00355f] transition-colors">Electricidad</h4>
                  <Zap className="w-5 h-5 text-[#fc8127]" />
                </div>
                <p className="text-gray-500 text-sm mb-5 leading-relaxed">Tableros, cortocircuitos e iluminación LED para el hogar.</p>
                <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                  <span className="text-[10px] font-extrabold text-gray-400 uppercase tracking-wider">Desde $12.000</span>
                  <button className="bg-blue-50 text-[#00355f] font-bold px-4 py-2 rounded-xl text-sm group-hover:bg-[#00355f] group-hover:text-white transition-colors">Solicitar</button>
                </div>
              </div>
            </div>
            ...
            {/* Carpintería */}
            <div className="w-[300px] shrink-0 bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:border-[#00355f] hover:shadow-xl transition-all group cursor-pointer" onClick={() => router.push('/buscar-profesionales?oficio=Carpintería')}>
              <div className="relative h-52 overflow-hidden">
              ...
              <div className="p-5">
                <div className="flex justify-between items-start mb-2">
                  <h4 className="font-extrabold text-lg text-gray-900 group-hover:text-[#00355f] transition-colors">Carpintería</h4>
                  <Wrench className="w-5 h-5 text-[#fc8127]" />
                </div>
                <p className="text-gray-500 text-sm mb-5 leading-relaxed">Muebles a medida y restauración de madera para tu hogar.</p>
                <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                  <span className="text-[10px] font-extrabold text-gray-400 uppercase tracking-wider">Desde $20.000</span>
                  <button className="bg-blue-50 text-[#00355f] font-bold px-4 py-2 rounded-xl text-sm group-hover:bg-[#00355f] group-hover:text-white transition-colors">Solicitar</button>
                </div>
              </div>
            </div>
            ...
            {/* Pintura — NUEVO */}
            <div className="w-[300px] shrink-0 bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:border-[#fc8127] hover:shadow-xl transition-all group cursor-pointer" onClick={() => router.push('/buscar-profesionales?oficio=Pintura')}>
              <div className="relative h-52 overflow-hidden">
                <img src="/images/oficio_pintura_pro.png" alt="Pintura" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                <div className="absolute top-3 left-3 bg-white/95 backdrop-blur px-3 py-1.5 rounded-full flex items-center gap-1.5 shadow-sm">
                  <Star className="w-3.5 h-3.5 fill-[#fc8127] text-[#fc8127]" />
                  <span className="text-xs font-bold text-[#00355f]">4.8 (130+)</span>
                </div>
                <div className="absolute top-3 right-3 bg-[#fc8127] text-white text-[9px] font-black uppercase px-2 py-1 rounded-full tracking-wide">Nuevo</div>
              </div>
              <div className="p-5">
                <div className="flex justify-between items-start mb-2">
                  <h4 className="font-extrabold text-lg text-gray-900 group-hover:text-[#fc8127] transition-colors">Pintura</h4>
                  <span className="text-[#fc8127] text-xl">🖌️</span>
                </div>
                <p className="text-gray-500 text-sm mb-5 leading-relaxed">Interior, exterior, texturado y pintura decorativa con terminación profesional.</p>
                <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                  <span className="text-[10px] font-extrabold text-gray-400 uppercase tracking-wider">Desde $14.000</span>
                  <button className="bg-orange-50 text-[#fc8127] font-bold px-4 py-2 rounded-xl text-sm group-hover:bg-[#fc8127] group-hover:text-white transition-colors">Solicitar</button>
                </div>
              </div>
            </div>

            {/* Gasista — NUEVO */}
            <div className="w-[300px] shrink-0 bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:border-[#00355f] hover:shadow-xl transition-all group cursor-pointer" onClick={() => router.push('/buscar-profesionales?oficio=Gasista')}>
              <div className="relative h-52 overflow-hidden">
                <img src="/images/oficio_gasista_pro.png" alt="Gasista" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                <div className="absolute top-3 left-3 bg-white/95 backdrop-blur px-3 py-1.5 rounded-full flex items-center gap-1.5 shadow-sm">
                  <Star className="w-3.5 h-3.5 fill-[#00355f] text-[#00355f]" />
                  <span className="text-xs font-bold text-[#00355f]">4.9 (75+)</span>
                </div>
                <div className="absolute top-3 right-3 bg-[#fc8127] text-white text-[9px] font-black uppercase px-2 py-1 rounded-full tracking-wide">Nuevo</div>
              </div>
              <div className="p-5">
                <div className="flex justify-between items-start mb-2">
                  <h4 className="font-extrabold text-lg text-gray-900 group-hover:text-[#00355f] transition-colors">Gasista</h4>
                  <span className="text-[#fc8127] text-xl">🔥</span>
                </div>
                <p className="text-gray-500 text-sm mb-5 leading-relaxed">Instalación de redes de gas, service de calefones y certificaciones habilitantes.</p>
                <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                  <span className="text-[10px] font-extrabold text-gray-400 uppercase tracking-wider">Desde $18.000</span>
                  <button className="bg-blue-50 text-[#00355f] font-bold px-4 py-2 rounded-xl text-sm group-hover:bg-[#00355f] group-hover:text-white transition-colors">Solicitar</button>
                </div>
              </div>
            </div>
            ...
            <div className="w-[300px] shrink-0 bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:border-[#00355f] hover:shadow-xl transition-all group cursor-pointer" onClick={() => router.push('/buscar-profesionales?oficio=Plomería')}>
              <div className="relative h-52 overflow-hidden">
                <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuATY8flL-MfyUm7rRccSGypPj-4UZKhm6f0Ld8Js-Y3Jem5W4lOqCr4eCWve4w8GwhlgYq5_JMnjV928e9nnbYOIJ0_Vb3PBLDdYHjIHjm4GOVsvEqzw7lHHUakYr-msGguBzKQF4ZeG8gJQLTVna6m7YHvOnOS9yTXxcpYeW0sTz_2ahlhfSiqOgKIs_kLSXZichHSHpzZjY9mUyh6N_OeICgK1KO023Svr-TJkSWtaZ4YW9670CZZoUh3lBF4qNu3gM5PpcyYXATG" alt="Plomería" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                <div className="absolute top-3 left-3 bg-white/95 backdrop-blur px-3 py-1.5 rounded-full flex items-center gap-1.5 shadow-sm"><Star className="w-3.5 h-3.5 fill-[#00355f] text-[#00355f]" /><span className="text-xs font-bold text-[#00355f]">4.9 (240+)</span></div>
              </div>
              <div className="p-5"><div className="flex justify-between items-start mb-2"><h4 className="font-extrabold text-lg text-gray-900 group-hover:text-[#00355f] transition-colors">Plomería</h4><Droplet className="w-5 h-5 text-[#fc8127]" /></div><p className="text-gray-500 text-sm mb-5 leading-relaxed">Reparaciones, instalaciones y urgencias las 24hs en todo momento.</p><div className="flex items-center justify-between pt-4 border-t border-gray-100"><span className="text-[10px] font-extrabold text-gray-400 uppercase tracking-wider">Desde $15.000</span><button className="bg-blue-50 text-[#00355f] font-bold px-4 py-2 rounded-xl text-sm group-hover:bg-[#00355f] group-hover:text-white transition-colors">Solicitar</button></div></div>
            </div>

            <div className="w-[300px] shrink-0 bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:border-[#00355f] hover:shadow-xl transition-all group cursor-pointer" onClick={() => router.push('/buscar-profesionales?oficio=Electricidad')}>
              <div className="relative h-52 overflow-hidden">
                <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuC1W2fOmSq-AynqbO3ZoWLKh_XWhnamU4gzNipXAwgMd19QXjrLW74lvJpK-ZQeavvPt4luRYD7mhyI0qQuA6QCs8afpj3cqqLqgCs6S4po0rIeUYesugVkfTIMWiABeNBgEH8TIKJHiZdH_Pv9DLWbTS8ggXJkSpU6taEOfoFmwVs-S04n62fGxmqyzsGqJSR4eb_sNOrD5MTYiXByZcjscbg4QHwR8TpMzDU7dtp1JrFSPFMp9pBSecyG65yj2h2KnVBnkMvHuipY" alt="Electricidad" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                <div className="absolute top-3 left-3 bg-white/95 backdrop-blur px-3 py-1.5 rounded-full flex items-center gap-1.5 shadow-sm"><Star className="w-3.5 h-3.5 fill-[#00355f] text-[#00355f]" /><span className="text-xs font-bold text-[#00355f]">4.8 (180+)</span></div>
              </div>
              <div className="p-5"><div className="flex justify-between items-start mb-2"><h4 className="font-extrabold text-lg text-gray-900 group-hover:text-[#00355f] transition-colors">Electricidad</h4><Zap className="w-5 h-5 text-[#fc8127]" /></div><p className="text-gray-500 text-sm mb-5 leading-relaxed">Tableros, cortocircuitos e iluminación LED para el hogar.</p><div className="flex items-center justify-between pt-4 border-t border-gray-100"><span className="text-[10px] font-extrabold text-gray-400 uppercase tracking-wider">Desde $12.000</span><button className="bg-blue-50 text-[#00355f] font-bold px-4 py-2 rounded-xl text-sm group-hover:bg-[#00355f] group-hover:text-white transition-colors">Solicitar</button></div></div>
            </div>

            <div className="w-[300px] shrink-0 bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:border-[#00355f] hover:shadow-xl transition-all group cursor-pointer" onClick={() => router.push('/buscar-profesionales?oficio=Carpintería')}>
              <div className="relative h-52 overflow-hidden">
                <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuBAgOMzC9Txmeq9CdoFTw6_3bgil2-7-nBXHS_JH8YoDFRU0aUZopfmpuA-HlTRhsBfhNq7UtZ5sJNxGknJ78rpxsA74yx2-c66pwyNbKlN5C0ND0dKlRwsNKYqC1vrGMoFbqZsg8Nj2LQpu3B6cKPAVRQIu_l5HNHCY7kwwrJPuIGByvijn4ykMiCSP0_cEYR26662kNy51kkFKQMrrjnsiBbUz26tkfatA__r1zQhH2MX4bxzm2_YDUHdpJS9fOB_BL2OQQ9CuTWH" alt="Carpintería" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                <div className="absolute top-3 left-3 bg-white/95 backdrop-blur px-3 py-1.5 rounded-full flex items-center gap-1.5 shadow-sm"><Star className="w-3.5 h-3.5 fill-[#00355f] text-[#00355f]" /><span className="text-xs font-bold text-[#00355f]">4.9 (95+)</span></div>
              </div>
              <div className="p-5"><div className="flex justify-between items-start mb-2"><h4 className="font-extrabold text-lg text-gray-900 group-hover:text-[#00355f] transition-colors">Carpintería</h4><Wrench className="w-5 h-5 text-[#fc8127]" /></div><p className="text-gray-500 text-sm mb-5 leading-relaxed">Muebles a medida y restauración de madera para tu hogar.</p><div className="flex items-center justify-between pt-4 border-t border-gray-100"><span className="text-[10px] font-extrabold text-gray-400 uppercase tracking-wider">Desde $20.000</span><button className="bg-blue-50 text-[#00355f] font-bold px-4 py-2 rounded-xl text-sm group-hover:bg-[#00355f] group-hover:text-white transition-colors">Solicitar</button></div></div>
            </div>

            <div className="w-[300px] shrink-0 bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:border-[#fc8127] hover:shadow-xl transition-all group cursor-pointer" onClick={() => router.push('/buscar-profesionales?oficio=Pintura')}>
              <div className="relative h-52 overflow-hidden">
                <img src="/images/oficio_pintura_pro.png" alt="Pintura" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                <div className="absolute top-3 left-3 bg-white/95 backdrop-blur px-3 py-1.5 rounded-full flex items-center gap-1.5 shadow-sm"><Star className="w-3.5 h-3.5 fill-[#fc8127] text-[#fc8127]" /><span className="text-xs font-bold text-[#00355f]">4.8 (130+)</span></div>
                <div className="absolute top-3 right-3 bg-[#fc8127] text-white text-[9px] font-black uppercase px-2 py-1 rounded-full tracking-wide">Nuevo</div>
              </div>
              <div className="p-5"><div className="flex justify-between items-start mb-2"><h4 className="font-extrabold text-lg text-gray-900 group-hover:text-[#fc8127] transition-colors">Pintura</h4><span className="text-[#fc8127] text-xl">🖌️</span></div><p className="text-gray-500 text-sm mb-5 leading-relaxed">Interior, exterior, texturado y pintura decorativa con terminación profesional.</p><div className="flex items-center justify-between pt-4 border-t border-gray-100"><span className="text-[10px] font-extrabold text-gray-400 uppercase tracking-wider">Desde $14.000</span><button className="bg-orange-50 text-[#fc8127] font-bold px-4 py-2 rounded-xl text-sm group-hover:bg-[#fc8127] group-hover:text-white transition-colors">Solicitar</button></div></div>
            </div>

            <div className="w-[300px] shrink-0 bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:border-[#00355f] hover:shadow-xl transition-all group cursor-pointer" onClick={() => router.push('/buscar-profesionales?oficio=Gasista')}>
              <div className="relative h-52 overflow-hidden">
                <img src="/images/oficio_gasista_pro.png" alt="Gasista" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                <div className="absolute top-3 left-3 bg-white/95 backdrop-blur px-3 py-1.5 rounded-full flex items-center gap-1.5 shadow-sm"><Star className="w-3.5 h-3.5 fill-[#00355f] text-[#00355f]" /><span className="text-xs font-bold text-[#00355f]">4.9 (75+)</span></div>
                <div className="absolute top-3 right-3 bg-[#fc8127] text-white text-[9px] font-black uppercase px-2 py-1 rounded-full tracking-wide">Nuevo</div>
              </div>
              <div className="p-5"><div className="flex justify-between items-start mb-2"><h4 className="font-extrabold text-lg text-gray-900 group-hover:text-[#00355f] transition-colors">Gasista</h4><span className="text-[#fc8127] text-xl">🔥</span></div><p className="text-gray-500 text-sm mb-5 leading-relaxed">Instalación de redes de gas, service de calefones y certificaciones habilitantes.</p><div className="flex items-center justify-between pt-4 border-t border-gray-100"><span className="text-[10px] font-extrabold text-gray-400 uppercase tracking-wider">Desde $18.000</span><button className="bg-blue-50 text-[#00355f] font-bold px-4 py-2 rounded-xl text-sm group-hover:bg-[#00355f] group-hover:text-white transition-colors">Solicitar</button></div></div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white p-5 rounded-2xl shadow-xl flex items-center gap-4 border border-gray-100">
                ...
                <div>
                  ...
                  <p className="text-base font-bold text-[#00355f]">+850mil /sem</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-500 font-medium">
                ...
                <li><button onClick={() => router.push('/privacidad')} className="hover:text-[#fc8127] transition-colors">Políticas de Privacidad</button></li>
                <li><button onClick={() => router.push('/soporte')} className="hover:text-[#fc8127] transition-colors">Soporte y Ayuda</button></li>
              </ul>
            </div>
          </div>
