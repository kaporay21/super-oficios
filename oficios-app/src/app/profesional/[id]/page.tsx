...
export default function PerfilProfesional() {
  ...
  // En el futuro, aquí haremos un fetch a Supabase usando params.id
  // Por ahora, usamos datos hardcodeados que coinciden con tu diseño
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 cursor-pointer" onClick={() => router.push('/')}>
              ...
              <div className="flex flex-col">
                <span className="font-extrabold text-xl text-[#00355f] leading-tight tracking-tight">
                  Oficios<span className="text-[#fc8127]">Ya</span>
                </span>
                <span className="text-[10px] text-[#00355f] font-medium leading-tight">
            ...
            <div className="bg-white border border-gray-200 p-6 rounded-2xl shadow-sm flex flex-col md:flex-row gap-6 items-start">
              <div className="relative shrink-0">
                <img 
                  ...
                  alt="Juan Pérez" 
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuA00HnxoSR8sMg49WGzW4CEH55P-IiOevciwGuILZtomo41Ths8yxjgqqcEmwCmQuaMEV33J4ykUDkZbS8FrPcJj1bTBOhmqopLHVb7RpdVoZpZoi8ZY35hMD3oQxhpWlu5d0qSKdnSCtnFaxkUzDnuIBJsY44Jq1vYqqrUsMaKYqRdGwM4jEOi-jro8_UklxxFY_OhHf7tnddMxDBHFQQ_O2syt2qm-ttX0bKWcGb2b5B1pN6jhd9HP7Ohab6muTspwQ9xeg4SxXxN"
                />
              ...
              <div className="flex-1 w-full">
                <div className="flex flex-wrap items-center gap-3 mb-1">
                  <h1 className="text-2xl font-bold text-[#00355f]">Juan Pérez</h1>
                  <span className="bg-green-50 text-green-700 border border-green-100 px-2.5 py-1 rounded-lg text-xs font-bold flex items-center gap-1">
                    <Star className="w-3.5 h-3.5 fill-green-700" /> 4.8
                  </span>
                </div>
                ...
                <div className="flex flex-wrap gap-5 mb-6">
                  <div className="flex flex-col">
                    <span className="text-lg text-[#00355f] font-bold">50+</span>
                    <span className="text-[10px] text-gray-500 font-bold uppercase tracking-wider">Trabajos</span>
                  </div>
                  <div className="w-px bg-gray-200"></div>
                  <div className="flex flex-col">
                    <span className="text-lg text-[#00355f] font-bold">10 años</span>
                    <span className="text-[10px] text-gray-500 font-bold uppercase tracking-wider">Exp</span>
                  </div>
                  <div className="w-px bg-gray-200"></div>
                  <div className="flex flex-col">
                    <span className="text-lg text-[#00355f] font-bold">CABA</span>
                    <span className="text-[10px] text-gray-500 font-bold uppercase tracking-wider">Zona</span>
                  </div>
                </div>
                
                {/* Botones de Acción (Presupuesto, Contacto y WhatsApp Directo) */}
                <div className="flex flex-col sm:flex-row gap-3">
                  <button onClick={() => router.push('/chat/1')} className="bg-[#fc8127] text-white px-5 py-3 rounded-xl font-bold flex items-center justify-center gap-2 hover:scale-[0.98] transition-all shadow-md sm:flex-1 active:scale-[0.98]">
                    <FileText className="w-5 h-5" /> Pedir Presupuesto
                  </button>
                  <button onClick={() => router.push('/chat/1')} className="border-2 border-[#00355f] text-[#00355f] px-5 py-3 rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-blue-50 transition-colors sm:w-auto active:scale-[0.98]">
                    <MessageSquare className="w-5 h-5" /> Contactar
                  </button>
                  <a 
                    href={`https://wa.me/5493811234567?text=${encodeURIComponent("Hola Juan, te contacto a través de OficiosYa y me gustaría pedirte un presupuesto.")}`}
                    target="_blank"
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <div className="col-span-2 row-span-2 relative group overflow-hidden rounded-2xl h-64 md:h-auto border border-gray-100 shadow-sm">
                  ...
                  />
                  <span className="absolute bottom-4 left-4 z-20 text-white font-bold text-sm">Renovación de baño</span>
                </div>
                <div className="relative group overflow-hidden rounded-2xl aspect-square border border-gray-100 shadow-sm">
                  <img className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt="Grifería" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBnyVVnQONVJ8PZ8gnbQKGIYn2AHQfQ49zRB76NjAEwDjOCBKI6R3hCKHVjX-ddmL2so9oojEdXtJpiuR495QyGuPFo9j5IDhQqHtPeVv5g3Amp78OXl0xK_1iOT6fJ_uZyCqFnQJek5Gk9zrQCb6j8oYIk_xCGQc7QscqK1rk8ouFHPJpVamKR6XCxBDvfnPqc8wmbLSfESOCGsx_n0C9iOvLND5Nxjqwo7B8unMKjN0NuLrSXe7I3R9xfbQzEmhgHEqxAMyBlX6i3"/>
                </div>
                <div className="relative group overflow-hidden rounded-2xl aspect-square border border-gray-100 shadow-sm">
                  <img className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt="Filtros" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAV3oeUMtvr-62lv2Y7V8pDDLGqViqkXUSExnL9Yfo0ub1BDzCktdL77TZIFRTlnwsPZaRl4idiREt7c3sI-pNMl-BtbuSJ_2kS_20f7zqOPFxDmbINB2P33vsgyFUNwAunfIROZqBHnVlO8JcVkGpFg7py-zlFczeZKLpkQw0Fm4t3CJ2izc1_QKnqKiwh1LQGXUgQpeqThJKHVKVnW7EUWN2weL8PXf-_r8hZtjwdqfRA67EGwAFDe34tvaVrVWVHTYvUfv0cdLFV"/>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white border border-gray-200 p-5 rounded-2xl shadow-sm">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    Juan fue súper puntual y resolvió el problema de la pérdida en la cocina rápidamente. Muy prolijo y educado. Lo recomiendo totalmente.
                  </p>
                </div>
                ...
                <div className="bg-white border border-gray-200 p-5 rounded-2xl shadow-sm">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    Excelente trabajo en la instalación del termotanque. Me explicó todo el proceso y el presupuesto fue el acordado desde un principio.
                  </p>
                </div>
              </div>
